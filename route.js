...
router.post('/validateUploadData', auth, ctrlAdmin.validateUploadData);
router.post('/addMultipleProduct', auth, ctrlAdmin.addMultipleProduct);
...
router.post('/multiplePrdImage', auth, ctrlAdmin.addMultiplePrdImage);
// prdThumbnail
